...
const rootMenus: RootMenuDefinition[] = [
  ...
  },
  {
    ...
    location: "main",
    type: "dropdown",
    url: "/reviewers/reviewers-guideline",
    order: 6,
    isActive: true,
  },
  {
...
const childMenus: ChildMenuDefinition[] = [
  ...
  },
  {
    ...
    location: "authors",
    type: "link",
    url: "/authors/article-processing-charge",
    order: 4,
    isActive: true,
  },
  {
    ...
    location: "authors",
    type: "link",
    url: "/authors/copyright-licensing",
    order: 5,
    isActive: true,
  },
  {
  ...
  },
  {
    ...
    location: "reviewers",
    type: "link",
    url: "/reviewers/peer-review-process",
    order: 2,
    isActive: true,
  },
];
...
const applyRootDefaults = async (existingMenu: any, menu: RootMenuDefinition) => {
  ...
  if (menu.label === "Submit Manuscript") {
    const oldLocalUrl = "/authors/submission-guidelines";
